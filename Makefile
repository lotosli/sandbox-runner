...
build:
	...
	$(GO) build -trimpath -ldflags "$(call build_ldflags,$(CURRENT_GOOS),$(CURRENT_GOARCH),$(CURRENT_GOARM))" -o $(LOCAL_BIN) ./cmd/sandbox-runner
...
$(call platform_binary,$1): | $(DIST_DIR)/.mkdir
	...
	$(GO) build -trimpath -ldflags "$(call build_ldflags,$(call platform_goos,$1),$(call platform_goarch,$1),$(call platform_goarm,$1))" -o $$@ ./cmd/sandbox-runner
endef
